...
**AI-powered prefab generation (May 2026)** <br>
...
Ggenerate 3D objects then apply segmentation for dividing each object for each segment, classify their types and what kind of physics rules should be applied then the pre-defined physics law of the simulation framework  is applied to the objects respectively.   <br>
